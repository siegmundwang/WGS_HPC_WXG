...
do
        #if [ -f ${RESULT}/QC/${i}/${i}.stat/${i}.cnt ] && [ -f ${RESULT}/QUANT/${i}/${i}.gene.results ]; then # 要测试非空
        if [ -s ${RESULT}/QC/${i}/${i}.stat/${i}.cnt ] && [ -s ${RESULT}/QUANT/${i}/${i}.genes.results ]; then
                ...
                #rm -rf !(*.fq.gz) & # 删除lane文件夹 very dangerous!
